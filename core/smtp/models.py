...
class EmailLog(models.Model):
    ...
    to_email = models.TextField(verbose_name="收件人")
    subject = models.CharField(max_length=255, verbose_name="邮件主题")
    text_body = models.TextField(blank=True, default="", verbose_name="纯文本正文")
    html_body = models.TextField(blank=True, default="", verbose_name="HTML正文")
