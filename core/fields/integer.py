            ...
            try:
                ...
                errors.extend(
                    self._validate_range(
                        min_value=int(self.field_config.get("min", float("-inf")))
                        if self.field_config.get("min")
                        else None,
                        max_value=int(self.field_config.get("max", float("inf")))
                        if self.field_config.get("max")
                        else None,
                    )
                )
            except ValueError:
