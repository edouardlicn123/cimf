    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value",
                    models.TextField(help_text="配置值（统一存字符串，服务层负责类型转换）", verbose_name="配置值"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.CharField(
                        db_index=True, help_text="URL 标识", max_length=128, unique=True, verbose_name="标识符"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_admin",
                    models.BooleanField(
                        default=False, help_text="是否为系统管理员（拥有后台管理权限）", verbose_name="系统管理员"
                    ),
                ),
                (
                    "role",
                ...
                (
                    ...
                    models.IntegerField(
                        default=0, help_text="连续登录失败次数，达到阈值后临时锁定", verbose_name="登录失败次数"
                    ),
                ),
                (
                    "locked_until",
                ...
                (
                    ...
                    models.BooleanField(
                        default=True, help_text="是否开启系统通知（新项目、任务提醒等）", verbose_name="开启通知"
                    ),
                ),
                (
                    "preferred_language",
                    models.CharField(
                        default="zh", help_text="首选界面语言：zh / en", max_length=10, verbose_name="首选语言"
                    ),
                ),
                (
                    "navigation_cards",
