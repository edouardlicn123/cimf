...
class LoginFormTestCase(TestCase):
    def test_login_form_valid_data(self):
        form = LoginForm(data={"username": "testuser", "password": "test12345678"})
        self.assertTrue(form.is_valid())

    def test_login_form_empty_username(self):
        form = LoginForm(data={"username": "", "password": "test12345678"})
    ...
    def test_login_form_short_username(self):
        form = LoginForm(data={"username": "ab", "password": "test12345678"})
        self.assertFalse(form.is_valid())
        self.assertIn("username", form.errors)
    ...
    def test_login_form_remember_me_optional(self):
        form = LoginForm(data={"username": "testuser", "password": "test12345678", "remember_me": True})
        self.assertTrue(form.is_valid())
