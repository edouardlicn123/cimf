...
def _build_customer_data(cd: dict) -> dict:
    ...
    return {
        ...
        "customer_code": cd.get("customer_code", "").strip(),
        "customer_type_id": cd.get("customer_type").id if cd.get("customer_type") else None,
        "enterprise_name": cd.get("enterprise_name", "").strip(),
        "phone1": cd.get("phone1", "").strip(),
        "email1": cd.get("email1", "").strip(),
        "phone2": cd.get("phone2", "").strip(),
        "email2": cd.get("email2", "").strip(),
        "linkedin": cd.get("linkedin", "").strip(),
        "country_id": cd.get("country").id if cd.get("country") else None,
        "province": cd.get("province", "").strip(),
        "address": cd.get("address", "").strip(),
        "postal_code": cd.get("postal_code", "").strip(),
        "industry": cd.get("industry", "").strip(),
        ...
        "website": cd.get("website", "").strip(),
        "notes": cd.get("notes", "").strip(),
    }
